...
public:
    ...
    static constexpr std::array<std::pair<std::string_view, TokenType>, 5> keywords = {{{"if", TokenType::If},
                                                                                        {"then", TokenType::Then},
                                                                                        {"else", TokenType::Else},
    ...
    position_t curr_pos() const {
        // :TODO, this should really be a "pair", i.e. start and end...
        return m_curr_pos;
    }

private:
    position_t m_curr_pos;
